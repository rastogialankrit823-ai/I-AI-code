...
export const clearSessionMemory = () => fetch(`${API_URL}/session/memory/clear`, { method: 'POST' }).then(r => r.json())
export const deleteSessionMemoryEntry = (id) => fetch(`${API_URL}/session/memory/${id}`, { method: 'DELETE' }).then(r => r.json())
